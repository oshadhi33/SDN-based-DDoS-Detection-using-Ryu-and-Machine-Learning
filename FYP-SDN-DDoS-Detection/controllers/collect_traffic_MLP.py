...
class SimpleMonitor13(switch.SimpleSwitch13):
    ...
    def flow_training(self):
        ...
        X_flow_test = scaler.fit_transform(X_flow_test)

        classifier = MLPClassifier(hidden_layer_sizes=(10,), max_iter=200, early_stopping=True, random_state=42)
        self.flow_model = classifier.fit(X_flow_train, y_flow_train)

        y_flow_pred = self.flow_model.predict(X_flow_test)

        self.logger.info("******* Performance of the MLP *******")
        self.logger.info("============================================================================")
        self.logger.info(" ")
